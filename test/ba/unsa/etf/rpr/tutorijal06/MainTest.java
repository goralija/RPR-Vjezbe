...
/*
    ...
    @Test
    public void number12times56Equals (FxRobot robot) {
        display = robot.lookup("#display").queryAs(Label.class);
        robot.clickOn("#btn1");
        robot.clickOn("#btn2");
        ...
        robot.clickOn("#btn6");
        robot.clickOn("#equalsBtn");
        assertEquals("672.0", display.getText());
    }

    @Test
    public void number112divide56Equals (FxRobot robot) {
        display = robot.lookup("#display").queryAs(Label.class);
        robot.clickOn("#btn1");
        robot.clickOn("#btn1");
        robot.clickOn("#btn2");
    ...
    @Test
    public void number112minus56Equals (FxRobot robot) {
        display = robot.lookup("#display").queryAs(Label.class);
        robot.clickOn("#btn1");
        robot.clickOn("#btn1");
        robot.clickOn("#btn2");
        ...
        robot.clickOn("#btn6");
        robot.clickOn("#equalsBtn");
        assertEquals("56.0", display.getText());
    }
