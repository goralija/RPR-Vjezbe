...
CREATE TABLE `drzava` (
  `id` int NOT NULL,
  `naziv` text,
  `glavni_grad` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `glavni_grad` (`glavni_grad`),
  CONSTRAINT `drzava_ibfk_1` FOREIGN KEY (`glavni_grad`) REFERENCES `grad` (`id`)
...
INSERT INTO `drzava` VALUES (1,'America',6),(2,'Srbija',8),(3,'BiH',7),(4,'Hrvatska',10),(5,'Francuska',5),(6,'Italija',9),(7,'Njemacka',11),(8,'Spanija',12),(9,'Japan',3),(10,'UK',4);
